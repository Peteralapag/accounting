...
return new class extends Migration
{
    ...
    {
        Schema::create('dbc_inventory_pcount', function (Blueprint $table) {
            ...
            $table->index(['item_code', 'trans_date'], 'idx_dbc_inventory_pcount');
        });
    }
    ...
    {
        Schema::dropIfExists('dbc_inventory_pcount');
    }
};
