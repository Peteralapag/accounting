...
return new class extends Migration
{
    ...
    {
        Schema::create('dbc_seasonal_mrs_item_transaction', function (Blueprint $table) {
            ...
            $table->integer('transaction_proceed')->nullable()->default(0);
        });
    }
    ...
    {
        Schema::dropIfExists('dbc_seasonal_mrs_item_transaction');
    }
};
