...
return new class extends Migration
{
    ...
    {
        Schema::create('wms_order_request', function (Blueprint $table) {
            $table->bigInteger('request_id', true);
            $table->string('cluster', 80)->nullable();
            $table->string('branch', 80)->nullable();
            $table->boolean('order_type')->nullable()->default(false);
            ...
            $table->index(['control_no', 'status', 'checked', 'approved'], 'control_no');
        });
    }
    ...
    {
        Schema::dropIfExists('wms_order_request');
    }
};
