...
return new class extends Migration
{
    ...
    {
        Schema::create('dbc_inventory_records', function (Blueprint $table) {
            $table->bigInteger('wid_id', true);
            $table->bigInteger('supplier_id')->nullable();
            $table->string('item_code', 50)->nullable()->index('idx_dbc_inventory_records');
    ...
    {
        Schema::dropIfExists('dbc_inventory_records');
    }
};
