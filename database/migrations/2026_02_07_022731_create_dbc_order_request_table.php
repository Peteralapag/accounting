...
return new class extends Migration
{
    ...
    {
        Schema::create('dbc_order_request', function (Blueprint $table) {
            ...
            $table->index(['branch', 'control_no'], 'idx_dbc_order_request');
            $table->primary(['request_id', 'control_no']);
        });
    }
    ...
    {
        Schema::dropIfExists('dbc_order_request');
    }
};
