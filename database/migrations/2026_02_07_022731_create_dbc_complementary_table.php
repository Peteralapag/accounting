...
return new class extends Migration
{
    ...
    {
        Schema::create('dbc_complementary', function (Blueprint $table) {
            ...
            $table->index(['report_date', 'branch', 'item_code'], 'idx_dbc_complementary');
        });
    }
    ...
    {
        Schema::dropIfExists('dbc_complementary');
    }
};
