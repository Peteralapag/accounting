...
return new class extends Migration
{
    ...
    {
        Schema::create('tbl_shared_memo', function (Blueprint $table) {
            $table->bigInteger('id', true);
            $table->bigInteger('shared_id')->nullable();
            $table->string('shared_to', 80)->nullable();
            $table->string('shared_by', 80)->nullable();
            $table->string('shared_from', 80)->nullable();
            $table->dateTime('date_shared')->nullable();
    ...
    {
        Schema::dropIfExists('tbl_shared_memo');
    }
};
