...
return new class extends Migration
{
    ...
    {
        Schema::create('dbc_seasonal_order_request', function (Blueprint $table) {
            ...
            $table->integer('partial_status')->nullable()->default(0);
        });
    }
    ...
    {
        Schema::dropIfExists('dbc_seasonal_order_request');
    }
};
