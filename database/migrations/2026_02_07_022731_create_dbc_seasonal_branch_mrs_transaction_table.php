...
return new class extends Migration
{
    ...
    {
        Schema::create('dbc_seasonal_branch_mrs_transaction', function (Blueprint $table) {
            $table->bigInteger('id', true);
            $table->string('request_id', 100)->nullable()->default('');
            $table->string('branch', 100)->nullable();
            $table->string('control_no', 100)->nullable()->default('');
            ...
            $table->string('branch_received', 100)->nullable();
            $table->string('branch_received_status', 6)->nullable()->default('0');
        });
    }
    ...
    {
        Schema::dropIfExists('dbc_seasonal_branch_mrs_transaction');
    }
};
