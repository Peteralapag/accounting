...
return new class extends Migration
{
    ...
    {
        Schema::create('dbc_charges_extension_record', function (Blueprint $table) {
            ...
            $table->index(['report_date', 'item_code'], 'idx_dbc_charges_extension');
        });
    }
    ...
    {
        Schema::dropIfExists('dbc_charges_extension_record');
    }
};
